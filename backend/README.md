...
## Project Structure
    ...
    ├── testapiautoconnect_118395  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_118395`
...
2. Clone this repo and `cd testapiautoconnect_118395`
